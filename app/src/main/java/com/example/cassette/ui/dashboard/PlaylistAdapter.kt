// PlaylistAdapter.kt (in com/example/cassette/ui/dashboard/)
package com.example.cassette.ui.dashboard // Make sure this package name matches your file's location
...
import com.example.cassette.R // Ensure you import your R file
import com.example.cassette.data.Playlist // Import your Playlist data class (make sure it's in com.internshala.echo)
